-- Fix delete_user_completely function - ALL public table user_id columns are UUID
...
BEGIN
  ...
  -- Delete from public tables - ALL user_id columns are UUID
  ...
  -- Delete user-owned data - ALL are UUID

...
const adminTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Offerte',
    description: 'Gestisci tutte le offerte: creane di nuove, aggiorna le versioni e condividile con i clienti per la firma.',
    position: 'bottom',
  ...
  notificationsStep,
  {
    ...
    title: 'Impostazioni',
    description: 'Accedi alle impostazioni per gestire utenti, clienti, prodotti, livelli tariffari e molto altro.',
    position: 'left',
...
const accountTourSteps: TourStep[] = [
  ...
  },
  {
    target: 'nav a[href="/offers"]',
    title: 'Offerte',
    description: 'Crea offerte professionali per i clienti, gestisci le versioni e inviale per la firma.',
    position: 'bottom',
    icon: createIcon(FileText),
  },
  {

...
export const docSearchIndex: SearchEntry[] = [
  ...
  { id: 'man-offerte', title: 'Offerte', section: 'Manuale', keywords: ['offerte', 'versioni', 'firma', 'fatture in cloud', 'fic', 'pdf', 'sconto'], snippet: 'Offerte versionate, piano di pagamento, firma del cliente e integrazione Fatture in Cloud.' },

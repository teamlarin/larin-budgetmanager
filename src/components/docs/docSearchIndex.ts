...
export const docSearchIndex: SearchEntry[] = [
  ...
  { id: 'man-budget', title: 'Budget', section: 'Manuale', keywords: ['budget', 'attività', 'data chiusura', 'prodotti', 'modello', 'template', 'alert', 'soglia', '50', '75', '90'], snippet: 'Gestione budget: creazione, attività, prodotti collegati, offerta in bozza automatica, alert 50/75/90/100%.' },
  { id: 'man-offerte', title: 'Offerte', section: 'Manuale', keywords: ['offerte', 'preventivi', 'numero', 'titolo', 'esito manuale', 'prodotti', 'categoria di ricavo', 'firma', 'fatture in cloud', 'fic', 'pdf', 'sconto'], snippet: 'Offerte: titolo e numero modificabili, righe prodotto, esito manuale, link pubblico, firma e Fatture in Cloud.' },
  { id: 'man-finanza', title: 'Finanza', section: 'Manuale', keywords: ['finanza', 'cruscotto', 'fatture', 'abbonamenti', 'gare', 'costo personale', 'wpzen', 'vendite'], snippet: 'Menu Finanza: cruscotto vendite, offerte, gare, fatture, abbonamenti e costo personale.' },
  ...
  { id: 'man-task', title: 'Task di progetto', section: 'Manuale', keywords: ['task', 'attività', 'scadenze', 'priorità', 'stati', 'assegnatari', 'rich text', 'ricorrenti', 'le mie task'], snippet: 'Task con scadenze, priorità, stati, assegnatari multipli, descrizione rich-text e collegamento all\'attività prevista.' },
  ...
  { id: 'man-calendario', title: 'Calendario e Planner', section: 'Manuale', keywords: ['calendario', 'planner', 'pianificazione settimanale', 'drag and drop', 'conferma ore', 'timesheet', 'pubblica', 'multi-utente', 'ricorrenza', 'token'], snippet: 'Vista giornaliera e Planner settimanale, drag & drop, conferma ore, task nel calendario, timesheet pubblica.' },

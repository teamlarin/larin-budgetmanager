      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          <div
            ...
            className="absolute left-[30%] right-1 rounded-[2px] shadow-sm border-l-4 overflow-hidden z-10 bg-yellow-100 border-yellow-400 dark:bg-yellow-900/30 cursor-pointer hover:bg-yellow-200 dark:hover:bg-yellow-900/50 transition-colors"
            onClick={() => setConvertDialogOpen(true)}
          >

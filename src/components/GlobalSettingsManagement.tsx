...
import { Save, AlertTriangle, Info, Euro } from 'lucide-react';
...
export const GlobalSettingsManagement = () => {
  ...
  const { data: overheadsSetting } = useQuery({
  ...
  const handleSave = () => {
    ...
    saveMutation.mutate({ warning: warningThreshold, critical: criticalThreshold });
  };
